...
export class DockStateService {
  ...
  toggleNotificationCenter(): void { this.displayNotificationCenter.update(v => !v); }
  ...
  setNotificationCenter(value: boolean): void { this.displayNotificationCenter.set(value); }
